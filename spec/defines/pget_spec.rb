...
describe 'pget' do
  ...
  shared_examples 'without user pass' do |protocol|
    ...
    it{
      should contain_exec("Download-puppet-3.4.1.msi-to-#{targetPath}").with({
        'provider' => 'powershell',
  ...
  %w(ftp sftp ftps https http).each do |protocol|
    ...
    describe "Download via #{protocol} without password" do
      ...
      it{
        expect{
          should contain_exec("Download-puppet-3.4.1.msi-to-#{targetPath}")
  ...
  %w(redhat ubuntu debian).each do |os|
    describe "Attempt using with #{os}" do
      ...
      it{
        expect {
          should contain_exec("Download-puppet-3.4.1.msi-to-C:/software/")
  ...
  describe "Download via puppet file" do
    ...
    it {
      should_not contain_exec("Download-puppet-3.4.1.msi-to-#{targetPath}")
